...
public class Gui extends JFrame {
	...
	public void initMoviePanel() {
		...
		addMovieButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(addMovieField.getText().replace(" ", "").isEmpty() ||
						addDateField.getText().replace(" ", "").isEmpty() ||
				...
				Movie m = RequestManagement.addMovie(addMovieField.getText().replace(" " , "-"), addDateField.getText(), genreList);
				
				if(m != null) response.setText("Movie added");
				else response.setText("The Movie has already been added !");
			}
		});
	}
	...
	public void initActorPanel() {
		...
		gbc.gridy++;
		JLabel responseText = new JLabel("Response :");
		actorPanel.add(responseText, gbc);
		...
		addActorButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Actor a = RequestManagement.addActor(addActorField.getText().replace(" " , "-"), addRoleField.getText());
				
				if(a != null) response.setText("Actor added");
	...
	public void initLinkPanel() {
		...
		linkButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean result = RequestManagement.link(linkMovieField.getText().replace(" " , "-"), linkActorField.getText().replace(" " , "-"));
				
				if(result) response.setText("Linked");
				else response.setText("The Actor has already been linked to the Movie.");
			}
		});
	}
	...
	public void initInfoPanel() {
		...
		infoButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Movie m = RequestManagement.get(getMovieField.getText().replace(" " , "-"));
				...
				if(m != null) {
					...
					s += "\n\n" + RequestManagement.getRanking(getMovieField.getText());
